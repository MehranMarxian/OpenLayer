...
- **Qwen-Image 2.1 edits repaint the whole frame.** Objects stay within a pixel of where they were, but untouched areas can come back slightly darker — 6 to 12 levels, measured on photographs. Compare before you keep an edit. Editing *only a selection* was built and cut from v0.35: on busy content the join was invisible, but in a smooth sky the selection's edge showed, and feathering it only softened the edge into a darker patch.
