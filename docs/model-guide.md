...
| Text to Image / Image to Image / FLUX.2 Klein | FLUX.2 Klein 4B (distilled, fp8) | `txt2img-flux2-klein`, `img2img-flux2-klein`. 4.07 GB, Apache-2.0, ungated. 4 steps at CFG 1. Shares `qwen_3_4b.safetensors` with the Z_image_Turbo stack. |
| Outpaint / FLUX.2 Klein | FLUX.2 Klein 4B (distilled, fp8) | `outpaint-flux2-klein`. Same files as the Klein text-to-image presets, plus the `comfyui-inpaint-cropandstitch` pack. |
