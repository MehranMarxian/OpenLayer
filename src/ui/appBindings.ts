...
export type ActionName =
  ...
  | "generateInpaint"
  | "importInpaint"
  | "captureRemoveBackgroundSource"
  | "captureRemoveBackgroundCanvasSource"
  | "generateRemoveBackground"
  | "importRemoveBackground"
  | "toggleRemoveBackgroundAutoImport"
  | "captureLayerMapsSource"
  | "captureLayerMapsCanvasSource"
  | "generateLayerMaps"
  | "importLayerMaps"
  | "toggleLayerMapsAutoImport"
